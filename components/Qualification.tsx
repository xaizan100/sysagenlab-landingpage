      ...
      <div className="grid md:grid-cols-2 gap-12">
        ...
        >
          <div className="flex items-center gap-4 mb-12">
            ...
            <span className="text-[9px] font-black uppercase tracking-[0.5em] text-brand-accent">Ideal Partner</span>
          </div>
          <h3 className="text-3xl font-black text-brand-white mb-12 tracking-tighter uppercase leading-[0.85]">Clinics serious about <br />structured growth.</h3>
        ...
        >
          <div className="flex items-center gap-4 mb-12">
            <div className="w-2 h-2 bg-brand-muted"></div>
            <span className="text-[9px] font-black uppercase tracking-[0.5em] text-brand-grey">Not a Fit</span>
          </div>
          <h3 className="text-3xl font-black text-brand-white mb-12 tracking-tighter uppercase leading-[0.85]">We are not a fit <br />for every clinic.</h3>
          <ul className="space-y-10">
            {[
