    ...
    <footer className="bg-white border-t border-brand-light pt-24 pb-12 px-6">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="pt-12 border-t border-brand-light flex flex-col sm:flex-row justify-between items-center gap-8">
          ...
          <div className="flex gap-10 text-brand-grey">
            <a href="https://www.instagram.com/sysagenlab/" target="_blank" rel="noopener noreferrer" className="hover:text-brand-black transition-all transform hover:scale-110">
            ...
            <a href="https://www.linkedin.com/company/sysagen-lab/" target="_blank" rel="noopener noreferrer" className="hover:text-brand-black transition-all transform hover:scale-110">
